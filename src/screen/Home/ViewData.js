...
export default function ViewData(props) {
    ...
    const loadData = useCallback(async () => {
        ...
        try {
            ...
            //   else {
            //     setDll_beneficiary_offline([])
            //     ToastAndroid.show(`No Beneficiary data to show!`, ToastAndroid.SHORT);
            //   }
    ...
    function renderItem({ item }) {
        return (
            <View style={{ flexDirection: 'row', marginTop: 10, }}>
                ...
                <TouchableOpacity style={{ flex: 1, backgroundColor: '#CECBCB', margin: 5, justifyContent: 'center', alignItems: 'center' }} onPress={() => props.navigation.navigate('DeleteData', { item })}
                >
